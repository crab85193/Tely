...
class ReservationParent(models.Model):
    ...
    store_tel_number     = models.CharField(blank=False, null=False, max_length=15, verbose_name='電話番号')
    store_name           = models.CharField(blank=True, null=True, max_length=100, verbose_name='店名')
